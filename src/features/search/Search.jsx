                ...
                <div className='col-3'>
                  <FormControl className='textf' variant='standard' sx={{ m: 1, minWidth: 120 }}>
                    ...
                    >
                      ...
                      <MenuItem value={'img'}>
                        <ImageIcon sx={{ color: red[500], fontSize: 20, marginRight: 1 }} /> Ảnh và
                        hình ảnh
                      </MenuItem>
                      <MenuItem value={'pdf'}>
                        <PictureAsPdfIcon sx={{ color: red[500], fontSize: 20, marginRight: 1 }} />{' '}
                        PDF
                      </MenuItem>
                      <MenuItem value={'document'}>
                        <ArticleIcon sx={{ color: red[500], fontSize: 20, marginRight: 1 }} /> Tài
                        liệu
                      </MenuItem>
                    </Select>
                  </FormControl>
